...
public class WeatherScriptAPINyc : MonoBehaviour
{
    public GameObject weatherTextObject;
        // add your personal API key after APPID= and before &units=
       string url = "https://api.openweathermap.org/data/2.5/weather?lat=40.71&lon=-74.00&APPID=d0b60f4bfd74b568afea3d576daa80a1&units=imperial";
