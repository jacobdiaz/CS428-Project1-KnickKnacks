...
public class WeatherAPIScriptMonaco : MonoBehaviour
{
    public GameObject weatherTextObject;
        // add your personal API key after APPID= and before &units=
       string url = "https://api.openweathermap.org/data/2.5/weather?lat=43.73&lon=7.42&APPID=d0b60f4bfd74b568afea3d576daa80a1&units=imperial";
